...
\begin{frame}{Control nodes}{Parallel and ParallelAll}
  \begin{figure}
    ...
    \end{tikzpicture}
    \caption{A \texttt{Parallel} node with thresholds \texttt{min\_success=3} and \texttt{min\_failure=2}: the subtree succeeds as soon as any three children succeed, and fails as soon as any two children fail; every remaining \texttt{RUNNING} child is halted.}
  \end{figure}
\end{frame}
